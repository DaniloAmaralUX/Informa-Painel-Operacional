...
export default function Breadcrumbs({
  ...
  useEffect(() => {
    (navigation?.allItems || navigation?.items)?.map((menu) => {
    ...
    breadcrumbContent = (
      ...
      >
        ...
        >
          {title && !titleBottom && (
            <Grid>
              <Typography variant="h2">{custom ? heading : main.title}</Typography>
            </Grid>
          )}
          <Grid>
          ...
          {title && titleBottom && (
            <Grid sx={{ mt: card === false ? 0.25 : 1 }}>
              <Typography variant="h2">{custom ? heading || main.title : main.title}</Typography>
            </Grid>
          )}
        </Grid>
